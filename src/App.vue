      ...
      <div class="bg-white p-4 shadow rounded">
        <div class="flex items-center justify-between -mx-4 mb-6">
          <div class="flex-1 px-4">
            <select @change="querySurahNumber" class="quran-input">
          ...
          <div class="flex-1 px-4 text-center">
            ...
            <p>
              {{ currentSurah.englishNameTranslation }} | Ayahs -
        ...
        <div v-else class="text-4xl">
          ...
          >
            <span
              class="text-xs w-5 h-5 flex items-center justify-center border rounded-full mr-4 mt-3"
...
export default {
  ...
  mounted() {
    ...
    this.querySpacificSurah(1);
  },

  methods: {
    querySurahNumber(e) {
      this.querySpacificSurah(e.target.value);
    },

    querySpacificSurah($surahNumber) {
      this.loading = true;
      axios
